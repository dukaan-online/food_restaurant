...
import shop_img_1 from "../images/shop.jpg"
import shop_img_2 from "../images/shop1.jpg"
import shop_img_3 from "../images/shop2.jpg"
        ...
        <Layout>
            <Box sx={{
                ...
                <Typography sx={{ mt: 2,ml:"auto" }} >
                    A restaurant is a business that prepares and serves food and drinks to customers.[1] Meals are generally served and eaten on the premises
                </Typography>
            </Box>
            <Box sx={{
                m: 3,
